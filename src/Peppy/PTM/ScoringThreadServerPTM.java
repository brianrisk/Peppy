...
public class ScoringThreadServerPTM {
	 ...
	 */
	public ScoringThreadServerPTM(ArrayList<Peptide> peptides, ArrayList<Spectrum> spectra, Sequence sequence) {
		...
		for (int threadNumber = 0; threadNumber < numberOfThreads; threadNumber++) {
			ScoringThreadPTM scorer = new ScoringThreadPTM(getNextSpectrum(), peptides, this, sequence);
