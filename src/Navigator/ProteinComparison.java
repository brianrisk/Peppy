...
public class ProteinComparison extends SetComparison{
	...
	public void addSet(String sampleName, MatchesToProtein matchesToProtein) {
		...
		if (matchesToProtein.getUniquePeptideCount() > maxUniquePeptideCount) maxUniquePeptideCount = matchesToProtein.getUniquePeptideCount();
		
		if (matchesToProtein.getMaxUniquePeptideScore() > maxUniquePeptideScore) maxUniquePeptideScore = matchesToProtein.getMaxUniquePeptideScore();
