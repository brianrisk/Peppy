...
public abstract class HTMLPage {
    ...
    protected void printH1(String string) {
        printH(string, 1);
    }

    protected void printH2(String string) {
        printH(string, 2);
    }

    protected void printH3(String string) {
        printH(string, 3);
    }
...
//		print("<script type=\"text/javascript\" src=\"../../sortable.js\"></script>");
    ...
    protected void printFooter() {
        ...
        print("<p>Created with <a href=\"http://geneffects.com/peppy\">Peppy</a>, protein identification, proteogenomic mapping software ");
