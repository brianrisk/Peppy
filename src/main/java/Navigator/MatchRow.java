 ...
 *
 */
public class MatchRow extends Row implements Comparable<MatchRow>{
	...
	public int compareTo(MatchRow other) {
	...
	public static ArrayList<MatchRow> loadMatches(File file) {
	...
	public boolean equals(MatchRow other) {
